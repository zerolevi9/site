...
INSERT INTO public.conteudo (contid,nome,classificacao,tipo,duracao) VALUES
...
INSERT INTO public.historico (histid,uswaid,nome,usuario,data,userid,contid) VALUES
...
INSERT INTO public.home (homeid,histid,conteudos,contatos,interacoes) VALUES
...
INSERT INTO public.mensagem (mensid,remetid,destid,mensagem,data,remetente,visualizada) VALUES
...
INSERT INTO public.usercomment (commentid,conteudo_contid,userid,usuario,texto,data,likes) VALUES
...
INSERT INTO public.userwatchcontent (uswaid,userid,contid,data,usuario,tempo,nome) VALUES
...
INSERT INTO public.usuario (userid,nome,idade,sexo,homeid) VALUES
	 (1,'Ash34ley',15,'F',1),
	 (2,'Kosh2',17,'M',2),
	 (3,'Monark56',14,'M',3),
	 (4,'Goku88',18,'M',4),
